...
dota_ckpt = 'work_dirs/rotated_rtmdet_l-3x-aug-data40/epoch_36.pth'  # noqa
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='./work_dirs/rtmdet_test/rotated_rtmdet_l-3x-aug_blur_noise-data40_tta')
