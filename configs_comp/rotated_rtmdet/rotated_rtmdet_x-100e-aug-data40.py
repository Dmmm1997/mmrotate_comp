...
train_dataloader = dict(
    batch_size=3, num_workers=8, dataset=dict(pipeline=train_pipeline))#44
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='./work_dirs/rtmdet_r/x_ss_1x_aug_load12ep')

max_epochs = 100
stage2_num_epochs = 10
base_lr = 0.002 / 16#base_lr = 0.004 / 16
interval = 20
